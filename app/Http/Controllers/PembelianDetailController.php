...
class PembelianDetailController extends Controller
{
    ...
    public function editBayar($id)
    {
        ...
        return view('pembelian_detail.editBayar', compact('id_pembelian', 'tanggal', 'detail_pembelian', 'produk', 'supplier', 'diskon'));
    }
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['harga_beli']  = '<input type="number" class="form-control input-sm harga_beli" data-id="'. $item->produk['id_produk'] .'" value="'. $item->produk['harga_beli'] .'">';
        ...
        return datatables()
            ->of($data)
            ->addIndexColumn()
            ->rawColumns(['aksi', 'kode_produk', 'jumlah', 'harga_beli', 'harga_jual'])
            ->make(true);
    }
    ...
    public function updateEdit(Request $request, $id)
    {
        ...
        $rekaman_stok = RekamanStok::where('id_pembelian', $detail->id_pembelian)->first();
        $cari = RekamanStok::where('id_pembelian', $detail->id_pembelian)->where('id_produk', $detail->id_produk)->first();
        if ($rekaman_stok->id_produk == $detail->id_produk) {
        ...
        } elseif($rekaman_stok->id_produk != $detail->id_produk && $cari != NULL) {
            $produk = Produk::find($detail->id_produk);
            $sum = $request->jumlah;
            $stok = $produk->stok;
            RekamanStok::create([
